...
import {
    Aliases, Find, Following, Links, Post, PostCreate, PostLike, PostLikes, PostReply, SetName, SetPic, SetProfile, View
} from "./modals/profile";
...
const Viewer = ({setLastUpdate, setModal, modalWindow, setChatRoom, modalProps = {}}) => {
    ...
    return (
        <div>
            ...
            {modalWindow === Modals.Aliases && <Aliases basic={basic}/>}
