        ...
        <Modal onClose={onClose}>
            <div className={styles.root}>
                <div className={styles.header}>
                    <h2>Add or Remove Addresses/Keys</h2>
                    <div>
                        <input type={"radio"} name={"addOrRemove"} id={"add"} value={"add"} checked={addOrRemove}
                               onChange={() => setAddOrRemove(true)}/>
                        <label htmlFor={"add"}>Add Addresses/Keys</label>
                        <input type={"radio"} name={"addOrRemove"} id={"remove"} value={"remove"} checked={!addOrRemove}
                               onChange={() => setAddOrRemove(false)}/>
                        <label htmlFor={"remove"}>Remove Addresses/Keys</label>
                    </div>
                </div>
